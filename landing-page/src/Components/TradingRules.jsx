...
function TradingRules() {
  const TradingRules1 = useInViewAnimation();
  const TradingRules2 = useInViewOnce();
  const TradingRules3 = useInViewOnce();
  const TradingRules4 = useInViewOnce();
  const TradingRules5 = useInViewOnce();
  ...
  return (
    <section className="overflow-hidden  md:pt-s160  lg:px-0 ">
      {/* Heading */}
      <h2
        ref={TradingRules1.ref}
        className=" max-w-7xl mx-auto px-s32 text-cente heading-h2 mb-s80 sm:mb-[200px] animate-ytop-fadein"
      >
        My Trading Rules
      </h2>
      ...
      <div className="relative w-full max-w-[1760px] mx-auto pt-[150px] md:pt-[150px]">
        <svg
          className="w-full z-50 h-auto transition scale-170 -translate-x-13 -translate-y-10 lg:scale-110 "
          xmlns="http://www.w3.org/2000/svg"
          width="1761"
          height="1542"
          viewBox="0 0 1761 1542"
          fill="none"
        >
          <path
            ref={pathRef}
            d="M-23 501.234C34.7266 530.21 382.788 750.859 476.506 571.952C535.79 458.779 287.635 233.123 517.068 55.5704C622.027 -25.6548 940.57 26.6024 871.232 270.73C783.973 577.955 929.424 553.134 1246.59 651.787C1531.48 740.399 1820.36 751.569 1721.02 1003.44C1698.85 1059.66 1505.22 1319.46 1350.95 1204.98C1150.35 1056.1 1089.4 499.806 795.37 662.829C711.753 709.19 560.03 993.692 937.357 1114.08C1168.97 1187.98 1115.28 1400.6 1101.45 1542"
            stroke="url(#paint0_linear_147_669)"
            strokeWidth="40"
            strokeMiterlimit="6"
            strokeLinecap="round"
          ...
          <foreignObject x="530" y="180" width="260" height="350">
            <p
              ref={TradingRules2.ref}
              className="text-2xl font-medium font-primary md:text-xl text-justify animate-z-fadein"
            >
              I invest with a long-term mindset, giving ideas enough time to
              grow. Short-term noise is ignored, and market timing is never
              forced
            </p>
          </foreignObject>
          ...
          <foreignObject x="1100" y="260" width="260" height="350">
            <p
              ref={TradingRules3.ref}
              className="text-2xl font-medium font-primary md:text-xl text-justify animate-z-fadein"
            >
              No borrowed money or external funds are ever used for trading.
              Only capital that allows clear thinking and disciplined decisions
              is deployed.
            </p>
          </foreignObject>
          ...
          <foreignObject x="780" y="755" width="250" height="300">
            <p
              ref={TradingRules4.ref}
              className="text-2xl font-medium font-primary md:text-xl text-justify animate-z-fadein"
            >
              These rules exist to protect mindset before protecting capital.
              Following them consistently matters more than any single trade
              outcome.
            </p>
          </foreignObject>
          ...
          <foreignObject x="1300" y="840" width="220" height="300">
            <p
              ref={TradingRules5.ref}
              className="text-2xl font-medium font-primary md:text-xl text-justify animate-z-fadein"
            >
              Breaking these rules once can cost more than multiple losing
              trades. Consistency comes from respect for process, not shortcuts.
            </p>
          </foreignObject>
        </svg>
      </div>
      ...
      >
        ...
        <p
          ref={textRef}
          className="relative z-10 max-w-[290px] heading-h3 md:max-w-2xl mx-auto text-white mix-blend-difference text-center px-6"
        >
          Some <span className="text-primary-main">rules</span> are meant to be
          <span className="text-primary-main"> broken</span> but these rules
          have taken me so far.
        </p>
      </div>
    </section>
  );
