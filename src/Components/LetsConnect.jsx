...
function LetsConnect() {
    ...
    return (
        <section id="letsConnect" data-nav="white" className="relative  h-screen flex items-center justify-center overflow-hidden">
...

{
    socialMedia.map((s)=>{
        return (
                    <a key={s.label} href={s.path} target="_blank" className=" rounded-full bg-black flex items-center justify-center hover:scale-110 transition">
